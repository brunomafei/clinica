...
# CADASTRO --------------------------------------------------------------------------------------
    ...
    def incluir_procedimento(self):
        ...
        try:
            novo_procedimento = Procedimento(dados['descricao'], dados['custo'], dados['profissional_responsavel'], dados['id_procedimento'])
            ...
            self.__tela_procedimento.mostra_mensagem("Procedimento incluído com sucesso.")
        except ElementoRepetidoException:
            self.__tela_procedimento.mostra_mensagem("Erro: Este elemento já existe. Tente novamente.")
...
# ALTERAÇÃO ------------------------------------------------------------------------------------------------------------------
    ...
    def alterar_procedimento(self):
        ...
        try:
            ...
            self.__tela_procedimento.mostra_mensagem("Erro: Elemento não encontrado.")
...
# REMOÇÃO ------------------------------------------------------------------------------------------------------------------
    ...
    def excluir_procedimento(self):
        ...
        try:
            ...
            self.__tela_procedimento.mostra_mensagem("Procedimento excluído com sucesso.")
        except ElementoNaoExisteException:
            self.__tela_procedimento.mostra_mensagem("Erro: Elemento não encontrado.")
