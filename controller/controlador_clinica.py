...
class ControladorClinica:
    ...
    def listar_clinicas(self):
        ...
        if len(clinicas) == 0:
            ...
            # Eu adiciono este return vazio para o sistema não quebrar se pedir a lista e ela não existir
            return []
        else:
            self.__tela_clinica.mostra_clinica(clinicas)
        
        # --- A CORREÇÃO ESTÁ AQUI ---
        # Eu adiciono este return para devolver a lista para o Relatório quando ele pedir
        return clinicas
